...
Copyright (c) 2021  Asm Safone <https://github.com/OP_SQUAD>
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data=="help":
        buttons = [
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/OP_SQUAD"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/burst_x_fire"),
            ],
            [
